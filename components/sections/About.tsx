        ...
        <AnimateOnScroll delay={0.2}>
          <div className="max-w-lg">
            ...
            <p className="mt-5 text-warm-gray text-[15px] leading-[1.85] font-sans font-light">
              ...
              destinations. From the cliffs of Santorini to the vineyards of Provence,
            ...
            <p className="mt-6 text-warm-gray/60 text-[13px] leading-relaxed font-sans font-light italic">
              When I&apos;m not behind the camera, you&apos;ll find me sailing the
              Cyclades, hunting for the perfect espresso, or planning my next
              adventure with my wife and our two cats.
            </p>
          </div>
        </AnimateOnScroll>
      </div>
